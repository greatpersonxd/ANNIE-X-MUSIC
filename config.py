...
BOT_NAME = getenv("BOT_NAME", "ᴋɪᴡɪ ✘ 𝙼ᴜsɪᴄ˼ ♪")
ASSUSERNAME = getenv("ASSUSERNAME", "kiwi_assistant")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/greatpersonxd/ANNIE-X-MUSIC")
